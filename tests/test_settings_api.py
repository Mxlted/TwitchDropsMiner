...
class TestSettingsAPI(unittest.IsolatedAsyncioTestCase):
    def test_settings_update_model(self):
        ...
        self.assertEqual(model.inventory_filters, {"show_upcoming": True})
        self.assertEqual(model.mining_benefits, {"BADGE": True})
    ...
    async def test_settings_manager_networking(self):
        ...
        with unittest.mock.patch(
            ...
            mock_console.print.assert_called_with(
                "Setting changed: mining_benefits = {'BADGE': False}"
            )
